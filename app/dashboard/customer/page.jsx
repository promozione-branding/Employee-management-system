...
import { FunnelPlus, Plus, Eye, Network, SquarePen, Trash } from "lucide-react";
import { Sheet, SheetContent } from "@/components/ui/sheet";
import CommonForm from "@/components/layout/Form";
import Loading from "@/components/layout/Loading";
import { addCustomerFormControl } from "@/config/data";
    ...
    <div className="flex flex-col gap-4 p-3 md:p-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-3">
          <div className="flex gap-2 items-center">
            <p className="font-medium hidden md:block">Showing</p>
      ...
      <div className="hidden md:block bg-white rounded-xl shadow border overflow-x-auto">
        <div className="grid md:grid-cols-5 lg:grid-cols-6 text-gray-500 border-b py-3 font-semibold px-4">
          <p>Name</p>
          <p>Company</p>
        ...
        {customers.map(
          ({ company, name, phone, GSTIN, salesExecutive, _id }, idx) => (
            <div
              key={_id}
              className={`grid grid-cols-6 md:grid-cols-5 lg:grid-cols-6 px-4 py-3 items-center border-b ${
                idx % 2 === 0 ? "bg-gray-50" : ""
              }`}
            >
              <p>{name}</p>
              ...
              <div className="flex justify-center gap-3 lg:gap-5">
                <Link href={`/dashboard/customer/work/${_id}`}>
                  <Network size={18}  className="cursor-pointer lg:h-6 lg:w-6"/>
                </Link>
                <Link href={`/dashboard/customer/${_id}`}>
