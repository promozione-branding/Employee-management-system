    ...
    <View style={styles.headerWrapper} fixed>
      <View style={styles.headerContainer}>
        <View style={styles.leftHeader2}>
          <Image style={styles.logoSmall} src={"/pdf/logo.png"} />
        </View>
        ...
        <View style={styles.rightHeader2}>
          ...
          <Text>Website: https://inquirybazaar.com/</Text>
        </View>
      </View>
    </View>
  );
    ...
    >
      ...
      {/* <Page size="A4" style={styles.page} >
       ...
       <PdfHeader />
        ...
        <View style={styles.termsList} >
          <Text style={styles.termItem} wrap>
            1) Inquiry Bazaar Pvt Ltd excludes any warranty,
            express or implied, as to the quality, accuracy, timeliness,
            completeness, performance, fitness, for a particular purpose of any
            of its contents, hosted on any of Inquiry Bazaar Pvt Ltd
             servers, unless otherwise specified in writing.
          </Text>

          <Text style={styles.termItem} wrap>
            2) Inquiry Bazaar Pvt Ltd will not be liable for any
          ...
          <Text style={styles.termItem} wrap>
            3) You indemnify Inquiry Bazaar Pvt Ltd of all claims,
          ...
          <Text style={styles.termItem} wrap>
            5) Inquiry Bazaar Pvt Ltd reserves the right to add or
          ...
          <Text style={styles.termItem} wrap>
            6) Corporate Profile prepared by third-party agencies will be a
            compilation of information of your organization. Inquiry Bazaar Pvt Ltd
             will be authorized to use this information for
          ...
          <Text style={styles.termItem} wrap>
            8) Inquiry Bazaar Pvt Ltd may have an option to convert
          ...
          <Text style={styles.termItem} wrap>
            9) Inquiry Bazaar Pvt Ltd reserves the right to
            add/modify/discontinue features offered with a service.
          </Text>
