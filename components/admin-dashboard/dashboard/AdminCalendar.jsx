...
import { createAdminCalenderService, getAdminCalenderService } from "@/service/admin-dashboard/dashboard-api";
...
const AdminCalendar = () => {
  ...
  const handleAddEvent = async (e) => {
    ...
    try {
      const res = await createAdminCalenderService({
  ...
  async function getCalendarItem() {
    try {
      if (adminDetail?._id) {
        const res = await getAdminCalenderService(adminDetail?._id);
  ...
  return (
    <div>
      <div className="border rounded-lg">
        <div className="bg-[#f3eaea] rounded-lg shadow-md md:p-2 h-[80vh]  p-1 md:h-[78vh] lg:h-auto">
