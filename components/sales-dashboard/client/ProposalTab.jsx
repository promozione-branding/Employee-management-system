...
import { getProposalService } from "@/service/sales-dashboard/proposal";
import {
  Album,
  Check,
  Download,
...
const ProposalTab = ({ customerId }) => {
  ...
  return (
    <div>
      ...
      <Link
        href={`/sales-dashboard/proposal/${customerId}`}
        className="fixed bottom-10 right-10 h-20 w-20 bg-blue-500 flex items-center justify-center rounded-full"
      >
        <Album size={30} />
      </Link>
    </div>
